<template>
  <div class="hilo" ref="hilo">
    ...
    <!-- 背景 -->
    <div class="hilo_bg hilo_bg_one" v-show="hiloBg == 'one'"></div>
    <div class="hilo_bg hilo_bg_two" v-show="hiloBg == 'two'"></div>
    <div class="hilo_bg hilo_bg_three" v-show="hiloBg == 'three'"></div>
    <div class="hilo_bg hilo_bg_four" v-show="hiloBg == 'four'"></div>
    <!-- 倒计时 -->
